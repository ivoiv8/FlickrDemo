...
@property (strong, nonatomic) FlickrSearchViewModel *viewModel;
...
- (UIViewController *)createInitialViewController {
    ...
    self.viewModel = [[FlickrSearchViewModel alloc]
                      initWithServices:self.viewModelServices];
    return [[FlickrSearchViewController alloc]
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ivayloivanov.FlickrDemo" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"FlickrDemo" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"FlickrDemo.sqlite"];
    NSError *error = nil;
