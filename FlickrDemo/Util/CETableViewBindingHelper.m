...
- (instancetype)initWithTableView:(UITableView *)tableView
  ...
  if (self = [super init]) {
    ...
    [source subscribeNext:^(id x) {
      ...
      _tableView.estimatedRowHeight = 360;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  SearchResultsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:_templateCell.reuseIdentifier];
...
- (CGFloat) tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        self.prototypeCell = [_tableView dequeueReusableCellWithIdentifier:_templateCell.reuseIdentifier];
    }
